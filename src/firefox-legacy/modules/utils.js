...
function isWindowPrivate(contentWindow) {
  var isPrivate = true;
  if (PrivateBrowsingUtils.isContentWindowPrivate) {
    // Firefox >= 35
    isPrivate = PrivateBrowsingUtils.isContentWindowPrivate(contentWindow);
  } else {
    // Firefox <= 34; i.e. PaleMoon
    isPrivate = PrivateBrowsingUtils.isWindowPrivate(contentWindow);
  }
